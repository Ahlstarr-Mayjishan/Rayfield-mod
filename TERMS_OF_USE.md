...
This document describes usage terms for Rayfield Mod distributions and source access.
...
- If a third party sells you an unauthorized copy, that transaction is between you and that seller.
- Maintainers do not provide refunds, chargebacks, or support for unauthorized sales.
...
- Maintainers may change pricing, support scope, and release channels for future versions.
- Prior public snapshots may still include third-party rights that cannot be revoked for those third-party components.
