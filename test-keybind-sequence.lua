-- Root wrapper for keybind sequence regression test.
...
local testSource = game:HttpGet(root .. "tests/regression/test-keybind-sequence.lua")
return compileChunk(testSource, "tests/regression/test-keybind-sequence.lua")()
